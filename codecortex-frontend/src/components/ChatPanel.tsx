                  ...
                  {SUGGESTIONS.map(s => (
                    <button key={s.text} onClick={() => setPrompt(s.text)}
                      ...
                      <span className="text-xs text-gray-500
                                       group-hover:text-gray-700 leading-snug">
                        {s.text}
                      </span>
                    </button>
                  ))}
                      ...
                      <div className="w-full">
                        {isEditingThis ? (
                          ...
                          <div className="flex flex-col gap-2">
                            ...
                            <div className="flex gap-2 justify-end">
                              ...
                              <button
                                ...
                                style={{
                                  background: 'linear-gradient(135deg, #E07820, #C06A1A)',
                                }}>
                                Save & Resend
                              </button>
                            </div>
                          ...
                          <div className="relative group/bubble flex flex-col items-end gap-1">
                            <div className="bg-gradient-to-br from-[#E07820] to-[#C06A1A]
                      ...
                      <div className="w-full space-y-2.5">
                        ...
                        {msg.code && (
                          <div className="w-full rounded-xl overflow-hidden
                                          border border-gray-200 bg-[#1e1e1e]">
                            <div className="flex items-center justify-between px-4 py-2
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-[10px] text-[#E07820] font-mono">
                                  {filename}
                                </span>
                              </div>
                              <div className="flex items-center gap-2">
                                ...
                                <button
                                  ...
                                  className="flex items-center gap-1 text-[10px]
                                             text-gray-400 hover:text-white px-2 py-0.5
                                             rounded hover:bg-white/10 transition-all">
                                  <Copy size={10} /> Copy
                                </button>
                              </div>
                            </div>
            ...
            {lastLang && (
              <p className="text-[10px] text-gray-400 mb-2">
                ...
                <span className="text-gray-400">
                  Language and style selected on send ↗
                </span>
              </p>
            )}
