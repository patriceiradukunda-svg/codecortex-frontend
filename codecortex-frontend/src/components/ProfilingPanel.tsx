...
import { Activity, Download, FileCode, FileJson, Cpu, MemoryStick, Zap, Clock, GitBranch, ClipboardPaste, Loader2 } from 'lucide-react'
      ...
      <div className="p-4 pt-0 space-y-2 mt-auto">
        ...
        <div className="grid grid-cols-3 gap-1.5">
          <button
            ...
            className="bg-[#2c2c2c] hover:bg-[#3c3c3c] text-white text-[11px] py-2 rounded-xl
                       flex flex-col items-center gap-1 transition-all"
          >
            <Download size={13} className="text-choco-light" />
            .c file
          </button>
          <button
            onClick={downloadPDF}
